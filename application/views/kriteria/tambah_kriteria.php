...
<div class="container-fluid">
    ...
    <div class="card border-left-primary">
        <div class="card-body shadow">
            <h5 class="font-weight-bold text-gray-600">Tambah Kriteria</h5>
            <div class="row">
                <div class="col-md-6">
                    <hr>
                    <?= form_open_multipart(base_url('kriteria/tambahKriteria'), ['id' => 'tambahKriteria']); ?>
                    <div class="form-group">
                        <?= form_label('Nama Kriteria', 'nama-kriteria', ['class' => 'h6']); ?>
                        <?= form_input(['name' => 'nama-kriteria', 'id' => 'nama-kriteria', 'class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Nama Kriteria']); ?>
                        <small class="form-text text-danger ml-3"><?= form_error('nama-kriteria'); ?></small>
                    </div>
                    <div class="form-group">
                        <?= form_label('Tipe', 'tipe-kriteria', ['class' => 'h6']); ?>
                        <?= form_dropdown('tipe-kriteria', $tipe, set_value('tipe-kriteria'), [
                            'id' => 'tipe-kriteria',
                    ...
                    <div class="form-group">
                        ...
                        <?= form_dropdown('bobot-kriteria', $bobotKriteria, set_value('bobot-kriteria'), [
                            'id' => 'bobot-kriteria',
                            'class' => 'form-control chosen schosen-select',
                    ...
                    <!-- <div class="form-group">
                        <?= form_label('Bobot', 'bobot-kriteria', ['class' => 'h6']); ?>
                        <?= form_input(['name' => 'bobot-kriteria', 'id' => 'bobot-kriteria', 'class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Bobot Kriteria']); ?>
                        <small class="form-text text-danger ml-3"><?= form_error('bobot-kriteria'); ?></small>
                    </div> -->
                </div>
            </div>
