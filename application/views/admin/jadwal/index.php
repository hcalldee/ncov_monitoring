    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open_multipart(base_url('index.php/admin/tambahJadwal'), ['id' => 'tambahJadwal']); ?>
...
<div class="modal fade" id="modal-jadwal-edit" tabindex="-1" role="dialog" aria-labelledby="modalSpesialis" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open_multipart(base_url('index.php/admin/editJadwal'), ['id' => 'editJadwal']); ?>
...
<script>
    ...
    function hapus(id) {
        $.ajax({
            url: '<?= base_url() ?>index.php/admin/hapusJadwal/' + id,
            data: {
                id: id
            },
            method: 'post',
            ...
            success: function(data) {
                window.location.href = '<?= base_url('index.php/admin/jadwal') ?>';
            }
        });
    }
    ...
    $('#tambahJadwal').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: '<?= base_url("index.php/admin/tambahJadwal") ?>',
            type: 'POST',
            dataType: 'JSON',
            data: $(this).serialize(),
            success: function(data) {
    ...
    $('.edit-jadwal').click('.timepicker-24-hr', function(e) {
        ...
        console.log(id);
        $.ajax({
            url: '<?= base_url("index.php/admin/getJadwal") ?>',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
        ...
        $('#editJadwal').submit(function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '<?= base_url("index.php/admin/editJadwal") ?>',
                type: 'POST',
                dataType: 'JSON',
                data: $(this).serialize(),
                success: function(data) {
                    ...
                    if (data.status != 'error') {
                        ...
                        if (data.message == 'Jadwal tidak ada perubahan') {
                            toastr.error('Jadwal tidak ada perubahan');
                        } else {
                            $('#modal-jadwal').modal('hide');
                            window.location.href = '<?= base_url('index.php/admin/jadwal') ?>';
                        }
