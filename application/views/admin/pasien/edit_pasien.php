...
<div class="container-fluid">
    ...
    <div class="card border-left-success">
        <div class="card-body shadow">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= form_open_multipart(base_url('index.php/admin/editPasien/') . $pasien->id, ['id' => 'editPasien']); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?= base_url('index.php/admin/pasien') ?>" class="btn btn-outline-secondary float-right mr-2">Kembali</a>
                    </div>
                    <?= form_close(); ?>
                </div>
            </div>
