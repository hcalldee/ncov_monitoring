    ...
    <div class="card border-left-success">
        <div class="card-body shadow">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="<?= base_url('index.php/admin/tambahPasien') ?>" class="btn btn-success btn-icon-split float-right">
                    ...
                    <?php foreach ($pasien as $p) : ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a class="btn btn-outline-warning btn-sm" href="<?= base_url('index.php/admin/editPasien/') . $p->id; ?>"><i class="fas fa-edit"></i></a>
...
<script>
    ...
    function hapus(id) {
        $.ajax({
            url: '<?= base_url() ?>index.php/admin/hapusPasien/' + id,
            data: {
                id: id
            },
            method: 'post',
            ...
            success: function(data) {
                window.location.href = '<?= base_url('index.php/admin/pasien') ?>';
            }
        });
    }
    ...
    $('.detail-pasien').on('click', function() {
        ...
        console.log(id);
        $.ajax({
            url: "<?= base_url(); ?>index.php/admin/detailPasien",
            method: "POST",
            data: {
                id: id
            },
