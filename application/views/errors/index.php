...
<div class="card ml-5 mr-5">
    <div id="container" style="width :100%; height:100%;" class="calendar-container"></div>
</div>
...
foreach ($jadwal as $data) {
    $dataku[$i] = array(
        ...
        'summary' => $data->deskripsi . '<br>' . '<button class="badge btn-success btn-sm detail-tindakan" data-toggle="modal" data-target="#modal-detail-tindakan-' . $data->id_tindakan . '" data-id="<?= $data->id_tindakan ?>"><i class="fas fa-info"></i></button>'
    );
    $i++; ?>

    <div class=" modal fade" id="modal-detail-tindakan-<?= $data->id_tindakan ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
